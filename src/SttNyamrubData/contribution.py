...
# Example usage
input_csv = (
    "data/contribution/kham_catalog_with_level.csv"  # Replace with your input file path
)
output_csv = "data/contribution_data_transformed/kham_training_transformed.csv"  # noqa  # Replace with your desired output file path
